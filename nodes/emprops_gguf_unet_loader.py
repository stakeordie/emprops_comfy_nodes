...
try:
    ...
    logger.error(f"[EmProps GGUF ERROR] Make sure ComfyUI-GGUF is installed in your custom_nodes directory")
    logger.error(f"[EmProps GGUF ERROR] Tried to import from: {gguf_path}")
